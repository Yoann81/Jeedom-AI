				...
				<form class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="password" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="apiKey" />
							</div>
						</div>
						<div class="form-group">
						<label class="col-sm-3 control-label">{{Modèle d'IA}}</label>
						<div class="col-sm-3">
							<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="model" placeholder="ex: gemini-1.5-flash ou gpt-4o" />
							<span class="help-block">{{Laissez vide pour utiliser le modèle par défaut.}}</span>
						</div>
					</div>
